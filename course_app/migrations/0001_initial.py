    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('format', models.CharField(choices=[('offline', 'offline'), ('online', 'online')], max_length=255, verbose_name='Формат обучения')),
                ('duration', models.CharField(max_length=255, verbose_name='Продолжительность курса')),
                ('certificate', models.CharField(choices=[('есть', 'есть'), ('нет', 'нет')], max_length=255, verbose_name='Сертификат по окончании')),
